...
const HomePage = () => {
  return (
    <div className="flex flex-col gap-12">
      <div className="bg-white rounded-lg flex flex-col gap-5 text-center -mt-16 shadow-md py-8">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <div className="flex flex-col items-center justify-center gap-4 text-center">
            ...
            <span>Download the Foodeat App for faster ordering and recomedination</span>
            <img src={appImage} />
        </div>
      </div>
    </div> 
